...
docs/completed/audit/phase1/ (10 docs):
  Code audit results from parallel reviewers

docs/completed/research/html-video-nle/ (10 docs):
...
Developer wants to understand a subsystem
  ...
  -> Plans are scattered across docs/completed/plans/, docs/refactor/, docs/completed/architecture/
```
...
3. **Planning docs have no index.** The 12 docs in `docs/completed/plans/` and 9 docs in `docs/refactor/` have no README or index file. A reader must scan filenames to find what they need.
...
5. **Audit and research docs are orphaned.** The `docs/completed/audit/` and `docs/completed/research/` directories contain valuable analysis but are never referenced from any index or navigation doc.
...
|------|------|----|-----------|
| `docs/features/FFMPEG_WASM_BUILD_PLAN.md` | `docs/features/` | `docs/completed/plans/` | This is a planning doc, not a feature reference. |
| `docs/completed/architecture/codeplan.md` | `docs/completed/architecture/` | `docs/completed/plans/` | This is an FFmpeg implementation plan, not architecture reference. Rename to `ffmpeg-wasm-codeplan.md`. |
| `docs/completed/misc/godO.md` | `docs/` | `docs/refactor/` | This is a refactoring plan. Its current location at `docs/` root is arbitrary. |
| `docs/completed/misc/REACT-BEST-PRACTICES.md` | `docs/` | `docs/reference/` | External reference material, not project-specific documentation. |
...
| `docs/completed/plans/README.md` | Index of all planning docs with status (active/completed/abandoned) and one-line descriptions. | 12 planning docs with no index is not navigable. |
...
│   │   ├── README.md                   # NEW: Index with status
│   │   ├── COMPLETED/
│   │   ├── godO-refactoring-plan.md    # MOVED+RENAMED from docs/completed/misc/godO.md
...
- `docs/completed/architecture/` directory (contents moved to plans/)
