...
**Date:** 2026-03-16
**Files reviewed:** CLAUDE.md, README.md, docs/features/README.md, docs/features/FEATURES.md, package.json, GPU-Engine.md, Timeline.md, AI-Integration.md, Effects.md, UI-Panels.md, Debugging.md, effects-system.md, plus docs/completed/plans/ and docs/refactor/ directory listings.
...
docs/completed/plans/        -> 12 plan documents
docs/refactor/     -> 7 refactor plans
docs/completed/research/     -> 10 research documents
docs/completed/architecture/ -> 1 file (codeplan.md)
docs/completed/audit/        -> 12 audit documents
```
...
4. **Research docs are orphaned:** docs/completed/research/html-video-nle/ contains 10 deep-dive documents. They are not linked from any other document.
...
#### 4. docs/completed/plans/ and docs/refactor/: Add status index
...
**Action:** Add a `docs/completed/plans/STATUS.md` index with a table showing each plan's status (active, completed, abandoned, superseded) and last-updated date.
