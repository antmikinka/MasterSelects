...
**Scope:** Core docs only (`docs/Features/`, `README.md`, `CLAUDE.md`). Skip
archived plan folders under `docs/completed/`.
...
| File | From | To | Reason |
|------|------|----|--------|
| `docs/Features/FFMPEG_WASM_BUILD_PLAN.md` | `docs/Features/` | `docs/completed/plans/` | Planning doc, not feature reference (Phase 3A) |
...
- Line 93: Move `FFMPEG_WASM_BUILD_PLAN.md` row to a separate "Planning Documents" section or add note "(see docs/completed/plans/)"
...
Move this file from `docs/Features/` to `docs/completed/plans/`. This is a planning document, not a feature reference.
...
**Total files moved:** 1 (FFMPEG_WASM_BUILD_PLAN.md -> docs/completed/plans/)
...
- [ ] `docs/completed/plans/FFMPEG_WASM_BUILD_PLAN.md` exists (moved from Features/)
